...
namespace FamilyBucksProgram.Users {
    ...
    class UserTests {
        ...
        public void The_user_records_provides_a_count_of_users_and_admins() {
            ...
            records.Save(factory.GenerateNew("alvin", "Alvin Sooq", false));
            records.Save(factory.GenerateNew("terra", "Terra Haute", true));
            records.Save(factory.GenerateNew("gitty", "Gyn Mitty", false));
        ...
        public void The_user_records_can_save_load_and_delete_records() {
            ...
            User saveUser = factory.GenerateNew("gitty", "Gyn Mitty", false);
